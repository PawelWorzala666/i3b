...
entry start
	...
	include 'source/include/opengl.inc'
...
Main:
	...
	invoke	CreateWindowEx,0,_class,_title,WS_VISIBLE+WS_OVERLAPPEDWINDOW+WS_CLIPCHILDREN+WS_CLIPSIBLINGS,16,16,[screen.iwidth],[screen.iheigth],NULL,NULL,[wc.hInstance],NULL
